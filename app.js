...
const STATES = [
  { code: "AL", name: "Alabama", region: "South", row: 7, col: 8 },
  { code: "AK", name: "Alaska", region: "West", row: 1, col: 1 },
  { code: "AZ", name: "Arizona", region: "West", row: 6, col: 3 },
  { code: "AR", name: "Arkansas", region: "South", row: 6, col: 6 },
  { code: "CA", name: "California", region: "West", row: 5, col: 2 },
  { code: "CO", name: "Colorado", region: "West", row: 5, col: 4 },
  { code: "CT", name: "Connecticut", region: "Northeast", row: 4, col: 11 },
  { code: "DE", name: "Delaware", region: "South", row: 5, col: 11 },
  { code: "FL", name: "Florida", region: "South", row: 8, col: 10 },
  { code: "GA", name: "Georgia", region: "South", row: 7, col: 9 },
  { code: "HI", name: "Hawaii", region: "West", row: 7, col: 1 },
  { code: "ID", name: "Idaho", region: "West", row: 3, col: 3 },
  { code: "IL", name: "Illinois", region: "Midwest", row: 4, col: 7 },
  { code: "IN", name: "Indiana", region: "Midwest", row: 5, col: 7 },
  { code: "IA", name: "Iowa", region: "Midwest", row: 4, col: 6 },
  { code: "KS", name: "Kansas", region: "Midwest", row: 6, col: 5 },
  { code: "KY", name: "Kentucky", region: "South", row: 6, col: 8 },
  { code: "LA", name: "Louisiana", region: "South", row: 7, col: 6 },
  { code: "ME", name: "Maine", region: "Northeast", row: 1, col: 12 },
  { code: "MD", name: "Maryland", region: "South", row: 5, col: 10 },
  { code: "MA", name: "Massachusetts", region: "Northeast", row: 3, col: 11 },
  { code: "MI", name: "Michigan", region: "Midwest", row: 3, col: 8 },
  { code: "MN", name: "Minnesota", region: "Midwest", row: 3, col: 6 },
  { code: "MS", name: "Mississippi", region: "South", row: 7, col: 7 },
  { code: "MO", name: "Missouri", region: "Midwest", row: 5, col: 6 },
  { code: "MT", name: "Montana", region: "West", row: 3, col: 4 },
  { code: "NE", name: "Nebraska", region: "Midwest", row: 5, col: 5 },
  { code: "NV", name: "Nevada", region: "West", row: 5, col: 3 },
  { code: "NH", name: "New Hampshire", region: "Northeast", row: 2, col: 12 },
  { code: "NJ", name: "New Jersey", region: "Northeast", row: 4, col: 10 },
  { code: "NM", name: "New Mexico", region: "West", row: 6, col: 4 },
  { code: "NY", name: "New York", region: "Northeast", row: 3, col: 10 },
  { code: "NC", name: "North Carolina", region: "South", row: 6, col: 10 },
  { code: "ND", name: "North Dakota", region: "Midwest", row: 3, col: 5 },
  { code: "OH", name: "Ohio", region: "Midwest", row: 4, col: 8 },
  { code: "OK", name: "Oklahoma", region: "South", row: 7, col: 5 },
  { code: "OR", name: "Oregon", region: "West", row: 4, col: 2 },
  { code: "PA", name: "Pennsylvania", region: "Northeast", row: 4, col: 9 },
  { code: "RI", name: "Rhode Island", region: "Northeast", row: 3, col: 12 },
  { code: "SC", name: "South Carolina", region: "South", row: 6, col: 9 },
  { code: "SD", name: "South Dakota", region: "Midwest", row: 4, col: 5 },
  { code: "TN", name: "Tennessee", region: "South", row: 6, col: 7 },
  { code: "TX", name: "Texas", region: "South", row: 8, col: 5 },
  { code: "UT", name: "Utah", region: "West", row: 4, col: 3 },
  { code: "VT", name: "Vermont", region: "Northeast", row: 2, col: 11 },
  { code: "VA", name: "Virginia", region: "South", row: 5, col: 9 },
  { code: "WA", name: "Washington", region: "West", row: 3, col: 2 },
  { code: "WV", name: "West Virginia", region: "South", row: 5, col: 8 },
  { code: "WI", name: "Wisconsin", region: "Midwest", row: 3, col: 7 },
  { code: "WY", name: "Wyoming", region: "West", row: 4, col: 4 },
];
